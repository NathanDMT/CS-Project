...
- La réalisation de ce projet doit permettre de couvrir au minimum les compétences suivantes (c’est indispensable pour le CCF de fin d’année)
...
- Rechercher comment utiliser une bdd Mysql avec C# (nous utiliserons la connexion en dur, c'està-dire codée par nous même sans utiliser le gestionnaire de connexion) => cela permet d’assurer la compatibilité du projet avec Visual studio express.
